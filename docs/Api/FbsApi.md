...
| [**getHiddenOffers()**](FbsApi.md#getHiddenOffers) | **GET** /campaigns/{campaignId}/hidden-offers | Информация о скрытых товарах |
...
| [**provideOrderItemCis()**](FbsApi.md#provideOrderItemCis) | **PUT** /campaigns/{campaignId}/orders/{orderId}/cis | Передача кодов «Честного знака» |
...
| [**updatePrices()**](FbsApi.md#updatePrices) | **POST** /campaigns/{campaignId}/offer-prices/updates | Установка цен на товары |
...
try {
    ...
    echo 'Exception when calling FbsApi->provideOrderItemCis: ', $e->getMessage(), PHP_EOL;
}
```
