...
| [**provideOrderItemCis()**](OrdersApi.md#provideOrderItemCis) | **PUT** /campaigns/{campaignId}/orders/{orderId}/cis | Передача кодов «Честного знака» |
...
try {
    ...
    echo 'Exception when calling OrdersApi->provideOrderItemCis: ', $e->getMessage(), PHP_EOL;
}
```
