...
/**
 * BriefOrderItemInstanceCisDTO Class Doc Comment
 *
 * @category Class
 * @description Маркировка единицы товара.
 * @package  YandexMarketApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class BriefOrderItemInstanceCisDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BriefOrderItemInstanceCisDTO';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cis'] === null) {
            $invalidProperties[] = "'cis' can't be null";
        }
